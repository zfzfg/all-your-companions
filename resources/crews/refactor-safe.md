...
name: refactor-safe
title: Safe refactor
when_to_use: Larger restructurings where each step should leave the project working.
roles: planner, implementer, reviewer, fixer
verify:
default_gate: manual
parallel: false
---
Plan, implement one plan step at a time with a verify after each, review.
