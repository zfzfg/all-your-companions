...
export const INBOUND_DISPOSITION: Record<WebviewMsg["type"], InboundDisposition> = {
  ...
  setCompanionsSetting: "host-local",
  childOverviewAction: "host-local",
  setSessionDelegation: "host-local",
  subagentApprovalAnswer: "host-local",
  workflowPlanEdit: "host-local",
  childMessage: "full",
  contextOverflowAnswer: "propose",
  continueInFreshSession: "full",
...
export const REMOTE_REQUIRES_BOUND_SESSION: Record<WebviewMsg["type"], boolean> = {
  ...
  setCompanionsSetting: false,
  childOverviewAction: false,
  setSessionDelegation: true,
  subagentApprovalAnswer: false,
  workflowPlanEdit: false,
  childMessage: true,
  contextOverflowAnswer: false,
  continueInFreshSession: false,
...
export const OUTBOUND_DISPOSITION: Record<HostMsg["type"], OutboundDisposition> = {
  ...
  scrollToWaiting: "mirror",
  runningChildren: "host-local",
  sessionDelegation: "host-local",
  subagentApprovalResolved: "host-local",
  subagentApproval: "host-local",
  childContext: "host-local",
  childActivity: "host-local",
  contextOverflow: "mirror",
  compactSummary: "mirror",
  nearFullPrompt: "mirror",
  planBlocked: "mirror",
...
export const OUTBOUND_PROJECT_AUTH: Record<HostMsg["type"], OutboundProjectAuth> = {
  ...
  scrollToWaiting: "none",
  runningChildren: "none",
  sessionDelegation: "scope",
  subagentApprovalResolved: "scope",
  subagentApproval: "scope",
  childContext: "scope",
  childActivity: "scope",
  contextOverflow: "scope",
  compactSummary: "scope",
  nearFullPrompt: "scope",
  planBlocked: "scope",
